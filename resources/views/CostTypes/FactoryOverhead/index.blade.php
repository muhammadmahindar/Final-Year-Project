@extends('layouts.app')
@section('title','Factory Overhead')
@section('BigHeading')
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4>New Cost Details</h4>
        </div>
        <div class="modal-body">
          <form role="form" action="{{route('FactoryOverhead.store')}}" method="POST">
            {{csrf_field()}}
...
@if(!$companyData==0)
  ...
  <div class="modal fade" id="editModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <a class="close" href="{{url('/FactoryOverhead')}}">&times;</a>
          <h4>Edit Factory Overhead Details</h4>
        </div>
        <div class="modal-body">
          <form role="form" action="{{route('FactoryOverhead.update',$companyData->id)}}" method="POST">
          ...
          <div class="form-group modal-footer">
            <a class="btn btn-default btn-default pull-left" href="{{url('/FactoryOverhead')}}">Back</a>
